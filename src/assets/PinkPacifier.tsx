...
const PinkPacifier: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    <g>
      ...
      />
      <path fill="#ee3d8b" d="M16 14a8 8 0 0 0-6.24 3h12.48A8 8 0 0 0 16 14z" />
      <path fill="#00267a" d="M16 14a8 8 0 0 0-6.24 3h12.48A8 8 0 0 0 16 14z" />
    </g>
  </svg>
);

export default PinkPacifier;
